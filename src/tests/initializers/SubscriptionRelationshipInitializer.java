...
public class SubscriptionRelationshipInitializer implements NodeInitializer, Control {
    ...
    private ID[] subscriptions;
    private double[] subscriptionProbabilitiesCache;
    ...
    public SubscriptionRelationshipInitializer(String configPrefix) {
        ...
        this.subscriptions = new ID[this.NUMBER_OF_TOPICS];
        this.subscriptionProbabilitiesCache = new double[this.NUMBER_OF_TOPICS];
